...
export function addDefaultHeaders(response: Response, delete_headers: string[] = []) {
  ...
  response.headers.set(
    ...
    "img-src 'self' www.googletagmanager.com googleads.g.doubleclick.net www.google.com blog-images.clickhouse.com data: mc.yandex.ru mc.yandex.com secure.gravatar.com s.w.org;" +
