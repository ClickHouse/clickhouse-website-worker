...
export function addDefaultHeaders(response: Response, delete_headers: string[] = []) {
  ...
  response.headers.set(
    ...
    "frame-src blob: 'self' https://www.youtube-nocookie.com www.youtube.com player.vimeo.com blog-images.clickhouse.com boards.greenhouse.io discover.clickhouse.com webto.salesforce.com bid.g.doubleclick.net app.hex.tech *.clickhouse.com https://js.driftt.com https://widget.drift.com;" +
